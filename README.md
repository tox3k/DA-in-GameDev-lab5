...
- Научился созданию виртуального пространства для ml-agenta и подключения его к Unity с помощью AnacondaPrompt
- Использовал библиотеку tenseorflow, чтобы создать и визуализировать графики для анализа результатов
